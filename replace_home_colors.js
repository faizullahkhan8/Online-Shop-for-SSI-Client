...
const targetFile = path.join(__dirname, 'frontend/src/Pages/HomePage.jsx');
...
const replacements = [
    ...
    { from: /from-\[\#0D2309\]/g, to: 'from-[#0D2309]' }, // keep this or change to dark?
    { from: /#74AA34/g, to: '#4d8d3a' }, // Catch-all for hex codes inside JS objects
...
console.log('Successfully replaced theme classes in HomePage.jsx');
